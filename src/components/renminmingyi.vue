<template>
  <div>
    ...
    <el-button type="success" class="c-show-code-button">
      <el-link href="https://github.com/seeksdream/relation-graph/blob/master/doc/demo/Demo4LayoutCenter.vue"
  ...
  methods: {
    showSeeksGraph(query) {
      var __graph_json_data = {
        'rootId': 'N13',
        'nodes': [
          { 'id': 'N1', 'text': '侯亮平', 'color': '#ec6941', 'borderColor': '#ff875e', 'innerHTML': '<div class="c-my-node" style="background-image: url(https://uploadstatic.mihoyo.com/contentweb/20220127/2022012718350213870.png);border:#ff875e solid 3px;"><div class="c-node-name" style="color:#ff875e">丽莎</div></div>' },
